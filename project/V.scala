...
// copied from https://github.com/typelevel/sbt-typelevel/blob/dabece743973d6e65fb5e632ecbefe5e6adfc0b0/kernel/src/main/scala/org/typelevel/sbt/kernel/V.scala

import scala.util.Try

final case class V(major: Int,
                   minor: Int,
                   patch: Option[Int],
